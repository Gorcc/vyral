...
export default function ProfilePage() {
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      setUserData(prev => prev ? { ...prev, user_name: userName, user_bio: userBio } : null)
      setEditing(false)
    } catch (err: any) {
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-8 mb-8">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-6 mb-6">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold">{userData?.user_name}'s Profile</h1>
                    <p className="text-sm text-gray-400 mt-1">Click the avatar to upload a new image</p>
                  </div>
                </div>
                ...
                <div>
                  {editing ? (
                    ...
                    <div>
                      <h2 className="text-2xl font-semibold mb-3">{userData.user_name}</h2>
                      <p className="text-gray-300 text-lg">{userData.user_bio || 'No bio yet'}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="md:text-right">
                ...
                <div className="flex gap-12 mt-8 md:justify-end">
                  <div className="text-center">
                    <div className="text-3xl font-bold">{userData?.subscribers || 0}</div>
          ...
          <div className="max-w-[2000px] mx-auto">
            ...
            {videos.length > 0 ? (
              ...
              <div className="text-center py-16 bg-[#212121] rounded-lg w-screen">
                <h2 className="text-2xl text-gray-400 mb-6">No videos uploaded yet</h2>
                <button
